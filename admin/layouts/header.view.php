...
$url_name = $url[sizeof($url) - 2];

function url()
{
    return explode("/", $_SERVER['SERVER_PROTOCOL'])[0] . "://" . $_SERVER['SERVER_NAME'] . "/";
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="<?= url() ?>admin/assets/css/boxicons.css" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= url() ?>admin/assets/css/core.css" class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= url() ?>admin/assets/css/theme-default.css" class="template-customizer-theme-css" />
    <link rel="stylesheet" href="<?= url() ?>admin/assets/css/demo.css" />

    <!-- Vendors CSS -->
    <link rel="stylesheet" href="<?= url() ?>admin/assets/css/perfect-scrollbar.css" />

    <link rel="stylesheet" href="<?= url() ?>admin/assets/css/apex-charts.css" />
    ...
    <!-- Helpers -->
    <script src="<?= url() ?>admin/assets/js/helpers.js"></script>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="<?= url() ?>admin/index.php" class="app-brand-link">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item <?= (($url_name == 'admin') || ($url_name == '')) ? "active" : "" ?>">
                        <a href="<?= url() ?>admin/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'banner') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/banner/create.php" class="menu-link">
                                    <div data-i18n="create_banner">Create banner</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/banner/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'service') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/service/create.php" class="menu-link">
                                    <div data-i18n="create_service">Create Service</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/service/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'feature') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/feature/create.php" class="menu-link">
                                    <div data-i18n="create_feature">Create Feature</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/feature/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= (($url_name == 'whyus') || ($url_name == 'about') || ($url_name == 'contact') || ($url_name == 'theme')) ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <!-- whyus -->
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/whyus/index.php" class="menu-link">
                                    <div data-i18n="WhyUs">WhyUs</div>
                                </a>
                            </li>
                            <!-- about -->
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/about/index.php" class="menu-link">
                                    <div data-i18n="About">About</div>
                                </a>
                            </li>
                            <!-- contact -->
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/contact/index.php" class="menu-link">
                                    <div data-i18n="About">Contact</div>
                                </a>
                            </li>
                            <!-- subscribers -->
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/subscriber/index.php" class="menu-link">
                                    <div data-i18n="About">Subscribes</div>
                                </a>
                            </li>
                            <!-- theme option -->
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/theme/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'counter') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/counter/create.php" class="menu-link">
                                    <div data-i18n="create_counter">Create Counter</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/counter/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'skill') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/skill/create.php" class="menu-link">
                                    <div data-i18n="create_skill">Create Skill</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/skill/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'testimonial') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/testimonial/create.php" class="menu-link">
                                    <div data-i18n="create_testimonial">Create Testimonial</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/testimonial/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'service_detail') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/service_detail/create.php" class="menu-link">
                                    <div data-i18n="create_details">Create Service Detail</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/service_detail/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'team') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/team/create.php" class="menu-link">
                                    <div data-i18n="create_details">Create New Member</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/team/index.php" class="menu-link">
                    ...
                    <li class="menu-item <?= ($url_name == 'portfolio') ? "active" : "" ?>">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/portfolio/create.php" class="menu-link">
                                    <div data-i18n="create_details">Create Portfolio</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?= url() ?>admin/portfolio/index.php" class="menu-link">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                    <div class="avatar avatar-online">
                                        <img src="<?= USER_IMAGE_SITE_PATH . 'user/' . $_SESSION['user']['avatar'] ?>" alt class="w-px-40 h-auto rounded-circle" />
                                    </div>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?= url() ?>admin/logout.php">
